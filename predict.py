...
def main():
    ...
    parser.add_argument("--vertice_dim", type=int, default=6172*3, help='number of vertices - 23370*3 for BIWI')
    ...
    parser.add_argument("--condition", type=str, default="3", help='select a conditioning subject from train_subjects')
    parser.add_argument("--subject", type=str, default="5", help='select a subject from test_subjects or train_subjects')
